    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-4 px-1 sm:gap-6 sm:px-0">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="grid grid-cols-1 gap-2 sm:flex sm:items-center">
          <Button size="md" variant="secondary" icon="cloud_upload" onClick={openVercelModal} className="whitespace-nowrap">
            Vercel Relay
          </Button>
          <Button size="md" variant="secondary" icon="upload" onClick={openBatchImportModal} className="whitespace-nowrap">
            Batch Import
          </Button>
          <Button size="md" icon="add" onClick={openCreateModal} className="whitespace-nowrap">Add Proxy Pool</Button>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <textarea
              ...
              className="w-full min-h-[180px] py-2 px-3 text-sm text-text-main bg-surface border border-border rounded-md focus:ring-1 focus:ring-primary/30 focus:border-primary/50 focus:outline-none transition-all"
            />
